...
export const formSections: FormSection[] = [
  ...
  },
  {
    id: "academic",
    title: "Academic & Work",
    description: "Education and work status",
    icon: "graduation-cap",
    fields: [
      {
        key: "Academic Status",
        ...
        type: "select",
        description: "Your current academic level (1-5 scale)",
        options: [
  ...
  },
  {
    ...
    description: "Your residential and financial status",
    icon: "home",
    fields: [
      {
  ...
  },
  {
    ...
    description: "Your health habits and conditions",
    icon: "heart-pulse",
    fields: [
      {
  ...
  },
  {
    ...
    description: "Daily habits and social connections",
    icon: "users",
    fields: [
      {
  ...
  },
  {
    ...
    description: "How you've been feeling lately",
    icon: "brain",
    fields: [
      {
        key: "Melancholic",
        label: "Feeling melancholic",
        type: "radio",
        options: [
          { value: 0, label: "No" },
          { value: 1, label: "Yes" },
      ...
      },
      {
        ...
        type: "radio",
        description: "Please answer honestly - your response is confidential",
        options: [
          { value: 0, label: "No" },
          { value: 1, label: "Yes" },
        ],
  ...
  },
  {
    ...
    description: "Changes in your daily behavior",
    icon: "activity",
    fields: [
      {
  ...
  },
  {
    ...
    description: "Physical manifestations you may be experiencing",
    icon: "thermometer",
    fields: [
      {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Lack of pleasure in activities",
        type: "radio",
        options: [
          { value: 0, label: "No" },
          { value: 1, label: "Yes" },
      ...
      },
      {
        ...
        label: "Difficulty sharing feelings",
        type: "radio",
        options: [
          { value: 0, label: "No" },
          { value: 1, label: "Yes" },
      ...
      },
      {
        ...
        label: "Emotions feel misaligned",
        type: "radio",
        options: [
          { value: 0, label: "No" },
          { value: 1, label: "Yes" },
      ...
      },
      {
        ...
        label: "Feeling your presence isn't genuine",
        type: "radio",
        options: [
          { value: 0, label: "No" },
          { value: 1, label: "Yes" },
